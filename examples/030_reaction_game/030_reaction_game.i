# 1 "C:\\Users\\rasyoung\\Desktop\\nugget-fwlib\\examples\\030_reaction_game\\030_reaction_game.S"
# 1 "<built-in>" 1
# 1 "C:\\Users\\rasyoung\\Desktop\\nugget-fwlib\\examples\\030_reaction_game\\030_reaction_game.S" 2
...
;'Set aside RAM memory locations for variables. All variables are global.
 ...
 RB_CODE EQU 37 ; 0X25
 RB_I EQU 38 ; 0X26
 RB_STOPWATCH_MS EQU 39 ; 0X27
 RB_STOPWATCH_MS_E EQU 42 ; 0X2A
 RB_STOPWATCH_MS_H EQU 40 ; 0X28
 RB_STOPWATCH_MS_U EQU 41 ; 0X29
 RB_STOPWATCH_READMS EQU 43 ; 0X2B
 RB_STOPWATCH_READMS_E EQU 46 ; 0X2E
 RB_STOPWATCH_READMS_H EQU 44 ; 0X2C
 RB_STOPWATCH_READMS_U EQU 45 ; 0X2D
 REACTIONMS EQU 47 ; 0X2F
 REACTIONMS_E EQU 50 ; 0X32
 REACTIONMS_H EQU 48 ; 0X30
 REACTIONMS_U EQU 49 ; 0X31
 SERDATA EQU 51 ; 0X33
 ...
 SYSPRINTBUFFLEN EQU 71 ; 0X47
 SYSPRINTDATAHANDLER EQU 72 ; 0X48
 SYSPRINTDATAHANDLER_H EQU 73 ; 0X49
 SYSPRINTTEMP EQU 74 ; 0X4A
 SYSREPEATTEMP1 EQU 75 ; 0X4B
 SYSSTRINGA EQU 119 ; 0X77 (SA)
 SYSSTRINGA_H EQU 120 ; 0X78 (SA)
 SYSTEMP1 EQU 76 ; 0X4C
 SYSTEMP1_E EQU 79 ; 0X4F
 SYSTEMP1_H EQU 77 ; 0X4D
 SYSTEMP1_U EQU 78 ; 0X4E
...
;'START_OF_THE_MAIN_PROGRAM
 ...
 CALL RB_STOPWATCH_RESET
 CALL PRINT_BANNER
SYSDOLOOP_S1:
 CALL WAIT_FOR_USER_READY
 CALL QUIET_WAIT_BEFORE_GO
 BTFSS SYSBITVAR0,0
 GOTO ELSE1_1
 CALL REPORT_FALSE_START
 GOTO ENDIF1
ELSE1_1:
 CALL RUN_REACTION_TRIAL
ENDIF1:
...
FN_RB_STOPWATCH_READMS:
 MOVF RB_STOPWATCH_MS,W
 MOVWF RB_STOPWATCH_READMS
 MOVF RB_STOPWATCH_MS_H,W
 MOVWF RB_STOPWATCH_READMS_H
 MOVF RB_STOPWATCH_MS_U,W
 MOVWF RB_STOPWATCH_READMS_U
 MOVF RB_STOPWATCH_MS_E,W
 MOVWF RB_STOPWATCH_READMS_E
 RETURN

;'********************************************************************************

RB_STOPWATCH_RESET:
 CLRF RB_STOPWATCH_MS
 CLRF RB_STOPWATCH_MS_H
 CLRF RB_STOPWATCH_MS_U
 CLRF RB_STOPWATCH_MS_E
 BCF SYSBITVAR1,1
 RETURN
...
RB_STOPWATCH_TICK1MS:
 BTFSS SYSBITVAR1,1
 GOTO ENDIF13
 INCF RB_STOPWATCH_MS,F
 BTFSC STATUS,2
 INCF RB_STOPWATCH_MS_H,F
 BTFSC STATUS,2
 INCF RB_STOPWATCH_MS_U,F
 BTFSC STATUS,2
 INCF RB_STOPWATCH_MS_E,F
ENDIF13:
 RETURN
...
SYSDOLOOP_S2:
 ...
 CLRF SYSWAITTEMPMS_H
 CALL DELAY_MS
 CALL RB_STOPWATCH_TICK1MS
 CALL FN_RB_SW1_ISPRESSED
 BTFSS SYSBITVAR0,4
 GOTO ENDIF4
 CALL FN_RB_STOPWATCH_READMS
 MOVF RB_STOPWATCH_READMS,W
 MOVWF REACTIONMS
 MOVF RB_STOPWATCH_READMS_H,W
 MOVWF REACTIONMS_H
 MOVF RB_STOPWATCH_READMS_U,W
 MOVWF REACTIONMS_U
 MOVF RB_STOPWATCH_READMS_E,W
 MOVWF REACTIONMS_E
 MOVLW 20
 MOVWF SYSWAITTEMPMS
 CLRF SYSWAITTEMPMS_H
